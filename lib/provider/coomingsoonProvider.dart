...
class CoomingsoonProvider extends ChangeNotifier {
  getUpcomingMovie() async {
    var result = await http.get(
        'https://api.themoviedb.org/3/movie/upcoming?api_key=5098a9e3ca4920eb139726beda7dbdf6&language=en-US&page=1');
